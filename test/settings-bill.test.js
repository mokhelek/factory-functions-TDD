describe("Testing Factory-Functions on Settings-Bill Widget", function () {
    it("should be able to set the call cost", function () {
        ...
        settingsBill2.setCallCosts(3.75);
        assert.equal(3.75, settingsBill2.getCallCosts());
    });
    ...
    it("should be able to set the sms cost", function () {
        ...
        let settingsBill2 = billSettings();
        settingsBill2.setSmsCosts(0.75);
        assert.equal(0.75, settingsBill2.getSmsCosts());
    });
    ...
    it("should be able to set both the sms and the call cost", function () {
        ...
        let settingsBill2 = billSettings();
        settingsBill2.setSmsCosts(0.55);
        settingsBill2.setCallCosts(3.85);
        assert.equal(0.55, settingsBill2.getSmsCosts());
        assert.equal(3.85, settingsBill2.getCallCosts());
    });
